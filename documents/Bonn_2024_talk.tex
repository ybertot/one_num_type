...
\end{itemize}
\item Typing helps, but not the type of natural numbers
\end{itemize}
\end{frame}
\begin{frame}
...
\item Here we will miss specific syntax for recursive definition
...
\item Provide different recursors for different recursion depths
\end{itemize}
\begin{small}
\begin{alltt}
Definition fibr := Rnat_rect_2 0 1
   (fun n fibr_n fibr_n' => fibr_n + fibr_n').

Lemma fibr0 : fibr 0 = 0.
Proof. ... Qed.

Lemma fibr1 : fibr 1 = 0.
Proof. ... Qed.

Lemma fibr_succ n : Rnat n -> fibr (n + 2) =
   fibr n + fibr (n + 1).
Proof. ... Qed.
\end{alltt}
\end{small}
